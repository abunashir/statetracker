...
ActiveRecord::Schema.define(version: 20170923091344) do
  ...
  create_table "tg_objects", force: :cascade do |t|
    ...
    t.index ["tg_object_id"], name: "index_tg_objects_on_tg_object_id", using: :btree
    t.index ["timestamp"], name: "index_tg_objects_on_timestamp", using: :btree
  end
